...
internal val logger: SkipLogger = SkipLogger(subsystem = "cbtreframe.module", category = "CBTReframe")

private typealias AppRootView = CBTReframeRootView
private typealias AppDelegate = CBTReframeAppDelegate
