...
/// A logger for the CBTReframe module.
let logger: Logger = Logger(subsystem: "com.cbt.reframe", category: "CBTReframe")
...
public final class CBTReframeAppDelegate: Sendable {
    public static let shared = CBTReframeAppDelegate()

    private init() {}

    public func onInit() { logger.debug("onInit") }
    public func onLaunch() { logger.debug("onLaunch") }
    public func onResume() { logger.debug("onResume") }
